                ...
                <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
                    <div class="auth-box h-full flex flex-col justify-center">
                        ...
                        <div class="text-center 2xl:mb-10 mb-4">
                            <h4 class="font-medium">ĐĂNG KÍ MIỄN PHÍ</h4>
                            <div class="text-slate-500 text-base">
                                Đăng kí tài khoản hoặc bạn có thể sử dụng tài khoản tại vuabem.com để đăng nhập <a href="/auth/login">TẠI ĐÂY</a>
                            </div>
                        </div>
                        <!-- BEGIN: Login Form -->

                        <form class="space-y-4" action='/api/register' method="POST" id="ajaxSubmitForm">
                            <input type="text" name="ref_user" value="<?= $users ?>" hidden>
                            ...
                            <button type="submit" class="btn btn-dark block w-full text-center">Đăng Kí</button>
                        </form>
